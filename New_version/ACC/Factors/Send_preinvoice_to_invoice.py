...
def Send_preinvoice_to_invoice(id):
    ...
    try:
        ...
        print(lookup_data)
        record = (None, lookup_data[0][1], lookup_data[0][2], lookup_data[0][3], lookup_data[0][4], lookup_data[0][5], lookup_data[0][6], lookup_data[0][7], lookup_data[0][8], lookup_data[0][9], 0)

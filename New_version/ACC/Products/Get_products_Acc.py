...
def Get_Product_acc_list(limit_id):
    try:
        ...
        sql_select_query = """select * from Accounting_Product_details where (id <= %s) ORDER BY id DESC LIMIT 20"""
        # set variable in query
        cursor.execute(sql_select_query, (limit_id,))
        # fetch result
